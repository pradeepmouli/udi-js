...
export declare const ISYBinaryStateDevice: <K extends Family, D extends Drivers, T extends Constructor<ISYDeviceNode<K, D | Drivers.Status>>>(Base: T) => {
    new (...args: any[]): {
        ...
        readonly type: any;
        _parentDevice: ISYDeviceNode<K, Drivers, string>;
        readonly children: ISYDeviceNode<K, Drivers, string>[];
        ...
        addChild(childDevice: ISYDeviceNode<K, Drivers, string>): void;
        readonly parentDevice: ISYDeviceNode<K, Drivers, string>;
        readProperty(propertyName: Drivers): Promise<import("../Definitions/PropertyStatus.js").PropertyStatus>;
        ...
        readonly formatted: { [x in Drivers.Status | D]?: any; };
        readonly uom: { [x_1 in Drivers]?: UnitOfMeasure; };
        readonly pending: import("../ISYNode.js").DriverValues<Drivers.Status | D>;
        readonly local: import("../ISYNode.js").DriverValues<Drivers.Status | D>;
        readonly flag: any;
...
export declare const ISYUpdateableBinaryStateDevice: <K extends Family, D extends Drivers, C extends string, T extends Constructor<ISYDeviceNode<K, D | Drivers.Status, C | "DON" | "DOF">>>(Base: T) => {
    new (...args: any[]): {
        get state(): Promise<boolean>;
...
export declare const ISYLevelDevice: <T extends Constructor<ISYDeviceNode<any>>>(base: T) => {
    new (...args: any[]): {
        ...
        readonly subCategory: number;
        readonly type: any;
        _parentDevice: ISYDeviceNode<any, Drivers, string>;
        readonly children: ISYDeviceNode<any, Drivers, string>[];
        readonly scenes: import("../ISYScene.js").ISYScene[];
        hidden: boolean;
        _enabled: any;
        productName: string;
        ...
        convertFrom(value: any, UnitOfMeasure: number, propertyName?: Drivers): any;
        addLink(isyScene: import("../ISYScene.js").ISYScene): void;
        addChild(childDevice: ISYDeviceNode<any, Drivers, string>): void;
        readonly parentDevice: ISYDeviceNode<any, Drivers, string>;
        readProperty(propertyName: Drivers): Promise<import("../Definitions/PropertyStatus.js").PropertyStatus>;
        readProperties(): Promise<import("../Definitions/PropertyStatus.js").PropertyStatus[]>;
        updateProperty(propertyName: string, value: string): Promise<any>;
        sendCommand(command: string, parameters?: Record<string | symbol, string | number> | string | number): Promise<any>;
        ...
        readonly uom: { [x in Drivers]?: UnitOfMeasure; };
        readonly pending: import("../ISYNode.js").DriverValues<Drivers>;
        readonly local: import("../ISYNode.js").DriverValues<Drivers>;
        readonly flag: any;
        readonly nodeDefId: string;
        readonly address: string;
        name: string;
