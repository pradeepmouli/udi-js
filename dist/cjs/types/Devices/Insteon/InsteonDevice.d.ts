...
export declare const InsteonLampDevice: <T extends Constructor<InsteonBaseDevice>>(IB: T) => {
    new (...args: any[]): {
        ...
        readonly type: any;
        _parentDevice: ISYDevice<Family.Insteon, import("../../Definitions/Global/Drivers.js").Drivers, string>;
        readonly children: ISYDevice<Family.Insteon, import("../../Definitions/Global/Drivers.js").Drivers, string>[];
        ...
        addChild(childDevice: ISYDevice<Family.Insteon, import("../../Definitions/Global/Drivers.js").Drivers, string>): void;
        readonly parentDevice: ISYDevice<Family.Insteon, import("../../Definitions/Global/Drivers.js").Drivers, string>;
