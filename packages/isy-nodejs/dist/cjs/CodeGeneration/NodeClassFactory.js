...
exports.buildNodeClasses = buildNodeClasses;
...
function createDriverSignatureReturnType(def, parent) {
    if (def.enum) {
        if (EnumDefinition_js_1.EnumDefinitionMap.has(parent.classDef.family)) {
            ...
            if (enumDef) {
                return typescript_1.factory.createTypeReferenceNode(typescript_1.factory.createIdentifier(enumDef.name), undefined);
            }
        }
        if (def.values) {
...
function createParameterSignature(def) {
    return typescript_1.factory.createParameterDeclaration(undefined, undefined, typescript_1.factory.createIdentifier(def.id ?? "value"), undefined, def.dataType
        ? typescript_1.factory.createUnionTypeNode(Object.values(def.dataType).map(p => createCommandParameterType(p, def)))
        : typescript_1.factory.createKeywordTypeNode(typescript_1.default.SyntaxKind.NumberKeyword), undefined);
}
...
function createDriverSignature(def) {
    return typescript_1.factory.createPropertySignature(undefined, typescript_1.factory.createIdentifier(def.id), typescript_1.factory.createToken(typescript_1.default.SyntaxKind.QuestionToken), typescript_1.factory.createTypeLiteralNode([
        ...
        typescript_1.factory.createPropertySignature(undefined, typescript_1.factory.createIdentifier("value"), undefined, def.dataType
            ? typescript_1.factory.createUnionTypeNode(Object.values(def.dataType).map(p => createDriverSignatureReturnType(p, def)))
            : typescript_1.factory.createKeywordTypeNode(typescript_1.default.SyntaxKind.NumberKeyword)),
    ]));
}
...
function createParameterDeclarationSignature(def) {
    return typescript_1.factory.createParameterDeclaration(undefined, undefined, typescript_1.factory.createIdentifier(def.name ?? "value"), undefined, def.dataType
        ? typescript_1.factory.createUnionTypeNode(Object.values(def.dataType).map(p => createCommandParameterType(p, def)))
        : typescript_1.factory.createKeywordTypeNode(typescript_1.default.SyntaxKind.NumberKeyword), undefined);
}
...
function createDriverGetDeclaration(def) {
    return typescript_1.factory.createGetAccessorDeclaration([typescript_1.factory.createToken(typescript_1.default.SyntaxKind.PublicKeyword)], typescript_1.factory.createIdentifier(def.name), [], typescript_1.factory.createUnionTypeNode(Object.values(def.dataType).map(p => createDriverPropertyReturnType(p, def))), typescript_1.factory.createBlock([
