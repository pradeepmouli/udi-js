...
const ElkAlarmSensorDevice_js_1 = require("./ElkAlarmSensorDevice.js");
/////////////////////////////
// ELKAlarmPanelDevice
//
class ELKAlarmPanelDevice extends ISYDeviceNode_js_1.ISYDeviceNode {
    ...
    constructor(isy, area) {
        super(isy, {
            family: Families_js_1.Family.Global, type: '0.0.0.0', enabled: true, address: `ElkAlarmPanel_${area}`, name: `Elk Alarm Panel ${area}`,
            pnode: undefined,
            startDelay: 0,
            hint: '',
            endDelay: 0,
...
})(AlarmPanelProperty || (exports.AlarmPanelProperty = AlarmPanelProperty = {}));
var AlarmMode;
(function (AlarmMode) {
...
})(AlarmTripState || (exports.AlarmTripState = AlarmTripState = {}));
var AlarmState;
(function (AlarmState) {
...
})(AlarmSensorPhysicalState || (exports.AlarmSensorPhysicalState = AlarmSensorPhysicalState = {}));
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_PHYSICAL_NOT_CONFIGURED = 0;
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_PHYSICAL_OPEN = 1;
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_PHYSICAL_EOL = 2;
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_PHYSICAL_SHORT = 3;
...
})(AlarmSensorLogicalState || (exports.AlarmSensorLogicalState = AlarmSensorLogicalState = {}));
// Physical status for sensors
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_LOGICAL_NORMAL = 0;
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_LOGICAL_TROUBLE = 1;
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_LOGICAL_VIOLATED = 2;
ElkAlarmSensorDevice_js_1.ElkAlarmSensorDevice.prototype.SENSOR_STATE_LOGICAL_BYPASSED = 3;
//# sourceMappingURL=ElkAlarmPanelDevice.js.map