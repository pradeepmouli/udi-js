...
class DimmerLampSwitchNode extends InsteonBaseDevice_js_1.InsteonBaseDevice {
    ...
    constructor(isy, nodeInfo) {
        ...
        this.drivers.OL = Drivers_js_1.Driver.create("OL", this, nodeInfo.property, { uom: UOM_js_1.UnitOfMeasure.Percent, label: "On Level", name: "onLevel" });
        this.drivers.RR = Drivers_js_1.Driver.create("RR", this, nodeInfo.property, { uom: UOM_js_1.UnitOfMeasure.Index, label: "Ramp Rate", name: "rampRate" });
