...
export declare class ISYNode<D extends Driver.Literal> extends EventEmitter implements PropertyChangedEventEmitter {
    readonly isy: ISY;
...
export declare class ISYNodeDevice<T extends Family, D extends Driver.Literal, C extends string> extends ISYNode<D> implements ISYDevice<T, D, C> {
    family: T;
    ...
    readonly type: any;
    _parentDevice: ISYNodeDevice<T, Driver.Literal, string>;
    readonly children: Array<ISYNodeDevice<T, Driver.Literal, string>>;
    ...
    convertFrom(value: any, UnitOfMeasure: number, propertyName?: Driver.Literal): any;
    addLink(isyScene: ISYScene): void;
    addChild<K extends ISYNodeDevice<T, any, any>>(childDevice: K): void;
