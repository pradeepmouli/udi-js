...
export class DimmerMotorSwitchAdvNode extends ISYDeviceNode {
    commands = {
        DON: this.on,
        DOF: this.off,
        DFOF: this.fastOff,
    ...
    constructor(isy, nodeInfo) {
        ...
        this.drivers.DUR = Driver.create("ST", this, nodeInfo.property, { uom: UnitOfMeasure.DurationInSeconds, label: "Max Duration", name: "maxDuration" });
