...
export class I3KeypadFlagsNode extends ISYDeviceNode {
    commands = {
        GV0: this.updateMode,
    ...
    constructor(isy, nodeInfo) {
        ...
        this.drivers.GV3 = Driver.create("ST", this, nodeInfo.property, { uom: UnitOfMeasure.Boolean, label: "Relay at Full On", name: "relayAtFullOn" });
        ...
        this.drivers.GV8 = Driver.create("ST", this, nodeInfo.property, { uom: UnitOfMeasure.Boolean, label: "Cleanup Reports", name: "cleanupReports" });
