...
export class Pir2844AdvNode extends ISYDeviceNode {
    commands = {
    ...
    constructor(isy, nodeInfo) {
        ...
        this.drivers.CLITEMP = Driver.create("ST", this, nodeInfo.property, { uom: UnitOfMeasure.Fahrenheit, label: "Temperature", name: "temperature" });
