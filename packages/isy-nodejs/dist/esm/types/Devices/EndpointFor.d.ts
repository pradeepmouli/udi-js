...
export declare const MatterEndpoint: <P extends EndpointType & MutableEndpoint, T extends Constructor<ISYDeviceNode<any, any, any>>>(base: T, endpointType: P) => {
    new (...args: any[]): {
        ...
        readonly type: any;
        _parentDevice: ISYDeviceNode<any, import("../Definitions/Global/Drivers.js").Driver.Literal, string>;
        readonly children: ISYDeviceNode<any, import("../Definitions/Global/Drivers.js").Driver.Literal, string>[];
        ...
        readonly parentDevice: ISYDeviceNode<any, import("../Definitions/Global/Drivers.js").Driver.Literal, string>;
