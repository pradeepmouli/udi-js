...
export declare const nodeDefId = "DimmerLampSwitch_ADV";
type Commands = {
...
export declare class DimmerLampSwitchAdvNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
...
export {};
//# sourceMappingURL=DimmerLampSwitchAdvNode.d.ts.map