...
export declare const nodeDefId = "DimmerLampSwitchLED_ADV";
type Commands = {
...
export declare class DimmerLampSwitchLedAdvNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
...
export {};
//# sourceMappingURL=DimmerLampSwitchLedAdvNode.d.ts.map