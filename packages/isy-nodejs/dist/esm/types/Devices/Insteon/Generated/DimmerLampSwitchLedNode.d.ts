...
export declare const nodeDefId = "DimmerLampSwitchLED";
type Commands = {
...
export declare class DimmerLampSwitchLedNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
...
export {};
//# sourceMappingURL=DimmerLampSwitchLedNode.d.ts.map