...
export declare const nodeDefId = "DimmerMotorSwitch_ADV";
type Commands = {
...
export declare class DimmerMotorSwitchAdvNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
...
export {};
//# sourceMappingURL=DimmerMotorSwitchAdvNode.d.ts.map