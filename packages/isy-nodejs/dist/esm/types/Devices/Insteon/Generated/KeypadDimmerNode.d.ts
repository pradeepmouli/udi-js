...
export declare const nodeDefId = "KeypadDimmer";
type Commands = {
...
export declare class KeypadDimmerNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
...
export {};
//# sourceMappingURL=KeypadDimmerNode.d.ts.map