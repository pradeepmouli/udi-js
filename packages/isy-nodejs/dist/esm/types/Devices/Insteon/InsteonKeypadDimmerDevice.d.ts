...
declare const InsteonKeypadDimmerDevice_base: {
    new (...args: any[]): {
        ...
        "__#61@#parentNode": import("../../ISYNode.js").ISYNode<any, any, any, any>;
        ...
        drivers: import("../../Definitions/index.js").Driver.ForAll<{
            ST: import("../../Definitions/index.js").Driver.Signature;
        }, false>;
        enabled: boolean;
        events: string;
        folder: string;
        ...
        sendCommand(command: "BEEP", parameters?: Record<string | symbol, string | number> | string | number): Promise<any>;
...
} & import("../Constructor.js").Constructor<import("./InsteonBaseDevice.js").InsteonBaseDevice<{}, {}>>;
export declare class InsteonKeypadDimmerDevice extends InsteonKeypadDimmerDevice_base {
    constructor(isy: ISY, deviceNode: NodeInfo);
}
export {};
//# sourceMappingURL=InsteonKeypadDimmerDevice.d.ts.map