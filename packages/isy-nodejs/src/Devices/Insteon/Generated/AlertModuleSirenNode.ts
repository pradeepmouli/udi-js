...
type Commands = AlertModuleSirenNode.Commands;
type Drivers = AlertModuleSirenNode.Drivers;

export class AlertModuleSirenNode extends Base<Drivers, Commands> {
...
export namespace AlertModuleSirenNode {
