...
type Commands = BinaryAlarmNode.Commands;
type Drivers = BinaryAlarmNode.Drivers;

export class BinaryAlarmNode extends Base<Drivers, Commands> {
...
export namespace BinaryAlarmNode {
