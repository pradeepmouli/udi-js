...
type Commands = BinaryControlNode.Commands;
type Drivers = BinaryControlNode.Drivers;

export class BinaryControlNode extends Base<Drivers, Commands> {
...
export namespace BinaryControlNode {
