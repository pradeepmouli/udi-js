...
type Commands = DimmerLampSwitchAdv.Commands;
type Drivers = DimmerLampSwitchAdv.Drivers;

export class DimmerLampSwitchAdvNode extends Base<Drivers, Commands> implements DimmerLampSwitchAdv.Interface {
	...
	declare readonly nodeDefId: "DimmerLampSwitch_ADV";
...
export namespace DimmerLampSwitchAdv {
	export interface Interface extends Omit<InstanceType<typeof DimmerLampSwitchAdvNode>, keyof ISYDeviceNode<any, any, any, any>> {
	...
	export const Node = DimmerLampSwitchAdvNode;
