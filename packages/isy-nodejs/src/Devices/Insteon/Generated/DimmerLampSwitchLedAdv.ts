...
export const nodeDefId = "DimmerLampSwitchLED_ADV";

type Commands = DimmerLampSwitchLedAdv.Commands;
type Drivers = DimmerLampSwitchLedAdv.Drivers;

export class DimmerLampSwitchLedAdvNode extends Base<Drivers, Commands> implements DimmerLampSwitchLedAdv.Interface {
	...
	static nodeDefId = "DimmerLampSwitchLED_ADV";
	declare readonly nodeDefId: "DimmerLampSwitchLED_ADV";
...
NodeFactory.register(DimmerLampSwitchLedAdvNode);

export namespace DimmerLampSwitchLedAdv {
	export interface Interface extends Omit<InstanceType<typeof DimmerLampSwitchLedAdvNode>, keyof ISYDeviceNode<any, any, any, any>> {
		nodeDefId: "DimmerLampSwitchLED_ADV";
	}
	export function is(node: ISYNode<any, any, any, any>): node is DimmerLampSwitchLedAdvNode {
		return node.nodeDefId === nodeDefId;
	}
	export function create(isy: ISY, nodeInfo: NodeInfo) {
		return new DimmerLampSwitchLedAdvNode(isy, nodeInfo);
	}
	export const Node = DimmerLampSwitchLedAdvNode;
