...
type Commands = DimmerLampSwitchLedAdvNode.Commands;
type Drivers = DimmerLampSwitchLedAdvNode.Drivers;

export class DimmerLampSwitchLedAdvNode extends Base<Drivers, Commands> {
...
export namespace DimmerLampSwitchLedAdvNode {
