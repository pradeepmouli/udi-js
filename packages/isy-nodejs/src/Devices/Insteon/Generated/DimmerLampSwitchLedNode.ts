...
type Commands = DimmerLampSwitchLedNode.Commands;
type Drivers = DimmerLampSwitchLedNode.Drivers;

export class DimmerLampSwitchLedNode extends Base<Drivers, Commands> {
...
export namespace DimmerLampSwitchLedNode {
