...
type Commands = DimmerMotorSwitchAdvNode.Commands;
type Drivers = DimmerMotorSwitchAdvNode.Drivers;

export class DimmerMotorSwitchAdvNode extends Base<Drivers, Commands> {
...
export namespace DimmerMotorSwitchAdvNode {
