...
type Commands = DimmerMotorSwitchNode.Commands;
type Drivers = DimmerMotorSwitchNode.Drivers;

export class DimmerMotorSwitchNode extends Base<Drivers, Commands> {
...
export namespace DimmerMotorSwitchNode {
