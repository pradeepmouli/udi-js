...
type Commands = FanLincMotorNode.Commands;
type Drivers = FanLincMotorNode.Drivers;

export class FanLincMotorNode extends Base<Drivers, Commands> {
...
export namespace FanLincMotorNode {
