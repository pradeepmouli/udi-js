...
export class I3KeypadFlagsNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
    ...
    constructor(isy: ISY, nodeInfo: NodeInfo) {
        ...
        this.drivers.GV3 = Driver.create("ST", this, nodeInfo.property as DriverState, { uom: UnitOfMeasure.Boolean, label: "Relay at Full On", name: "relayAtFullOn" });
        ...
        this.drivers.GV8 = Driver.create("ST", this, nodeInfo.property as DriverState, { uom: UnitOfMeasure.Boolean, label: "Cleanup Reports", name: "cleanupReports" });
    ...
    async updateRelayAtFullOn(value: I3OnOff) {
    ...
    async updateCleanupReports(value: I3OnOff) {
    ...
    public get relayAtFullOn(): I3OnOff {
    ...
    public get cleanupReports(): I3OnOff {
