...
type Commands = I3KeypadFlagsNode.Commands;
type Drivers = I3KeypadFlagsNode.Drivers;

export class I3KeypadFlagsNode extends Base<Drivers, Commands> {
...
export namespace I3KeypadFlagsNode {
