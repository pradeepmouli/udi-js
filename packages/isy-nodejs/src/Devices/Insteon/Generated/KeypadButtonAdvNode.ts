...
type Commands = KeypadButtonAdvNode.Commands;
type Drivers = KeypadButtonAdvNode.Drivers;

export class KeypadButtonAdvNode extends Base<Drivers, Commands> {
...
export namespace KeypadButtonAdvNode {
