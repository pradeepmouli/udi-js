...
type Commands = KeypadButtonNode.Commands;
type Drivers = KeypadButtonNode.Drivers;

export class KeypadButtonNode extends Base<Drivers, Commands> {
...
export namespace KeypadButtonNode {
