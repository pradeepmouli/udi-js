...
export const nodeDefId = "KeypadDimmer_ADV";

type Commands = KeypadDimmerAdv.Commands;
type Drivers = KeypadDimmerAdv.Drivers;

export class KeypadDimmerAdvNode extends Base<Drivers, Commands> implements KeypadDimmerAdv.Interface {
	...
	static nodeDefId = "KeypadDimmer_ADV";
	declare readonly nodeDefId: "KeypadDimmer_ADV";
...
NodeFactory.register(KeypadDimmerAdvNode);

export namespace KeypadDimmerAdv {
	export interface Interface extends Omit<InstanceType<typeof KeypadDimmerAdvNode>, keyof ISYDeviceNode<any, any, any, any>> {
		nodeDefId: "KeypadDimmer_ADV";
	}
	export function is(node: ISYNode<any, any, any, any>): node is KeypadDimmerAdvNode {
		return node.nodeDefId === nodeDefId;
	}
	export function create(isy: ISY, nodeInfo: NodeInfo) {
		return new KeypadDimmerAdvNode(isy, nodeInfo);
	}
	export const Node = KeypadDimmerAdvNode;
