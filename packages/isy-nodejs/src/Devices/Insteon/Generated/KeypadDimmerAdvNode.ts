...
type Commands = KeypadDimmerAdvNode.Commands;
type Drivers = KeypadDimmerAdvNode.Drivers;

export class KeypadDimmerAdvNode extends Base<Drivers, Commands> {
...
export namespace KeypadDimmerAdvNode {
