...
type Commands = KeypadDimmerNode.Commands;
type Drivers = KeypadDimmerNode.Drivers;

export class KeypadDimmerNode extends Base<Drivers, Commands> {
...
export namespace KeypadDimmerNode {
