...
type Commands = KeypadRelayNode.Commands;
type Drivers = KeypadRelayNode.Drivers;

export class KeypadRelayNode extends Base<Drivers, Commands> {
...
export namespace KeypadRelayNode {
