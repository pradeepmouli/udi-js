...
type Commands = Pir2844Adv.Commands;
type Drivers = Pir2844Adv.Drivers;

export class Pir2844AdvNode extends Base<Drivers, Commands> implements Pir2844Adv.Interface {
	...
	declare readonly nodeDefId: "PIR2844_ADV";
...
export namespace Pir2844Adv {
	export interface Interface extends Omit<InstanceType<typeof Pir2844AdvNode>, keyof ISYDeviceNode<any, any, any, any>> {
		nodeDefId: "PIR2844_ADV";
	}
	export function is(node: ISYNode<any, any, any, any>): node is Pir2844AdvNode {
		return node.nodeDefId === nodeDefId;
	}
	export function create(isy: ISY, nodeInfo: NodeInfo) {
		return new Pir2844AdvNode(isy, nodeInfo);
	}
	export const Node = Pir2844AdvNode;
