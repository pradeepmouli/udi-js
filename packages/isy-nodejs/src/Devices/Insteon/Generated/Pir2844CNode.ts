...
export const nodeDefId = "PIR2844C";
type Commands = {
...
export class Pir2844cNode extends ISYDeviceNode<Family.Insteon, keyof Drivers, keyof Commands> {
    ...
    constructor(isy: ISY, nodeInfo: NodeInfo) {
        ...
        this.drivers.CLITEMP = Driver.create("ST", this, nodeInfo.property as DriverState, { uom: UnitOfMeasure.Celsius, label: "Temperature", name: "temperature" });
