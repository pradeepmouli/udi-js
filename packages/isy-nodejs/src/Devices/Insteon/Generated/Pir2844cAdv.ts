...
export class Pir2844cAdvNode extends SirenAlert implements Pir2844cAdv.Interface {
	...
	declare readonly nodeDefId: "PIR2844C_ADV";
...
NodeFactory.register(Pir2844cAdvNode);

export namespace Pir2844cAdv {
	export interface Interface extends Omit<InstanceType<typeof Pir2844cAdvNode>, keyof ISYDeviceNode<any, any, any, any>> {
		nodeDefId: "PIR2844C_ADV";
	}
	export function is(node: ISYNode<any, any, any, any>): node is Pir2844cAdvNode {
		return node.nodeDefId === nodeDefId;
	}
	export function create(isy: ISY, nodeInfo: NodeInfo) {
		return new Pir2844cAdvNode(isy, nodeInfo);
	}
	export const Node = Pir2844cAdvNode;
