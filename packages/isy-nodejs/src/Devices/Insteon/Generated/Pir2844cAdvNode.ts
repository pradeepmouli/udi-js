...
type Commands = Pir2844cAdvNode.Commands;
type Drivers = Pir2844cAdvNode.Drivers;

export class Pir2844cAdvNode extends Base<Drivers, Commands> {
...
export namespace Pir2844cAdvNode {
