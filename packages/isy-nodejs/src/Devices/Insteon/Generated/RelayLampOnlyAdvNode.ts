...
type Commands = RelayLampOnlyAdvNode.Commands;
type Drivers = RelayLampOnlyAdvNode.Drivers;

export class RelayLampOnlyAdvNode extends Base<Drivers, Commands> {
...
export namespace RelayLampOnlyAdvNode {
