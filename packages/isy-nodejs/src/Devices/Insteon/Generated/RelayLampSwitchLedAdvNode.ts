...
type Commands = RelayLampSwitchLedAdvNode.Commands;
type Drivers = RelayLampSwitchLedAdvNode.Drivers;

export class RelayLampSwitchLedAdvNode extends Base<Drivers, Commands> {
...
export namespace RelayLampSwitchLedAdvNode {
