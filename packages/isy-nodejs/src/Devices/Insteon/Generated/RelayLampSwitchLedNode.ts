...
type Commands = RelayLampSwitchLedNode.Commands;
type Drivers = RelayLampSwitchLedNode.Drivers;

export class RelayLampSwitchLedNode extends Base<Drivers, Commands> {
...
export namespace RelayLampSwitchLedNode {
