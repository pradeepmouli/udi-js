...
type Commands = RelaySwitchOnlyAdvNode.Commands;
type Drivers = RelaySwitchOnlyAdvNode.Drivers;

export class RelaySwitchOnlyAdvNode extends Base<Drivers, Commands> {
...
export namespace RelaySwitchOnlyAdvNode {
