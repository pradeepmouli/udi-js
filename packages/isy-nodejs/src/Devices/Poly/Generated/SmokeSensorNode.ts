...
type Commands = SmokeSensorNode.Commands;
type Drivers = SmokeSensorNode.Drivers;

export class SmokeSensorNode extends Base<Drivers, Commands> {
...
export namespace SmokeSensorNode {
