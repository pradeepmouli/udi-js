...
type Commands = InsteonDimmer.Commands;
type Drivers = InsteonDimmer.Drivers;

export class InsteonDimmerNode extends Base<Drivers, Commands> implements InsteonDimmer.Interface {
...
NodeFactory.register(InsteonDimmerNode);

export namespace InsteonDimmer {
	export interface Interface extends Omit<InstanceType<typeof InsteonDimmerNode>, keyof ISYDeviceNode<any, any, any, any>> {
		nodeDefId: "InsteonDimmer";
	}
	export function is(node: ISYNode<any, any, any, any>): node is InsteonDimmerNode {
		return node.nodeDefId === nodeDefId;
	}
	export function create(isy: ISY, nodeInfo: NodeInfo) {
		return new InsteonDimmerNode(isy, nodeInfo);
	}
	export const Node = InsteonDimmerNode;
