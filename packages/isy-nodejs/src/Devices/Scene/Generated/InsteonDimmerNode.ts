...
type Commands = InsteonDimmerNode.Commands;
type Drivers = InsteonDimmerNode.Drivers;

export class InsteonDimmerNode extends Base<Drivers, Commands> {
...
export namespace InsteonDimmerNode {
