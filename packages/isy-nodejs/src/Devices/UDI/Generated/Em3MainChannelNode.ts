...
type Commands = Em3MainChannelNode.Commands;
type Drivers = Em3MainChannelNode.Drivers;

export class Em3MainChannelNode extends Base<Drivers, Commands> {
...
export namespace Em3MainChannelNode {
