...
export class PulseCounterNode extends ISYNode<Family.UDI, keyof Drivers, keyof Commands> {
    ...
    constructor(isy: ISY, nodeInfo: NodeInfo) {
        ...
        this.drivers.CPW = Driver.create("ST", this, nodeInfo.property as DriverState, { uom: UnitOfMeasure.Watt, label: "Current Power", name: "currentPower" });
