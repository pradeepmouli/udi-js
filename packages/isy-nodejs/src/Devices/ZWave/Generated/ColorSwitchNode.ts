...
type Commands = ColorSwitchNode.Commands;
type Drivers = ColorSwitchNode.Drivers;

export class ColorSwitchNode extends Base<Drivers, Commands> {
...
export namespace ColorSwitchNode {
