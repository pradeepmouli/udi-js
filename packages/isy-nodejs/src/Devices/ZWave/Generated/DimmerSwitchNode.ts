...
type Commands = DimmerSwitchNode.Commands;
type Drivers = DimmerSwitchNode.Drivers;

export class DimmerSwitchNode extends Base<Drivers, Commands> {
...
export namespace DimmerSwitchNode {
