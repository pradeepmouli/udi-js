...
export type DriverValues<DK extends Drivers = Drivers.Status> = {[x in DK|keyof Drivers]?:any};

export class ISYNode<D extends Drivers = Drivers> extends EventEmitter implements PropertyChangedEventEmitter {
  public readonly isy: ISY;

  public readonly formatted: { [x in D]? } = {};
  public readonly uom: { [x in Drivers]?: UnitOfMeasure } = { ST: UnitOfMeasure.Boolean };
...
export class ISYDeviceNode<T extends Family, D extends Drivers = Drivers, Commands extends string = string> extends ISYNode<D> {
  ...
  public _parentDevice: ISYDeviceNode<T, Drivers, string>;
  public readonly children: Array<ISYDeviceNode<T, Drivers, string>> = [];
  ...
  public addChild(childDevice: ISYDeviceNode<T, Drivers, string>) {
