...
async function parseProfileFiles(data: { profiles: { profile: any; }; }) {
...
function parseNLS(data: string, family = Family.Insteon, profile : number) {
...
function parseNodeDefs(data: { nodeDefs: any; }, family = Family.Insteon, profile : number) {
    //const filePath = path.join(__dirname, "nls.txt");
    let s = data.nodeDefs;
...
function parseEditorDefs(response: { editors: { editor: EditorDef[]; }; }, family: any, profile : number) {
...
function parseEventMap(response: any, family: any, profile : number) {
...
function parseLinkDefs(response: any, family: any, profile : number) {
